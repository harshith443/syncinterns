...
class Game extends JPanel {
    ...
    private static Font FONT_M = new Font("SERIF", Font.PLAIN, 40);
    private static Font FONT_M_ITALIC = new Font("SERIF", Font.ITALIC, 24);
    private static Font FONT_L = new Font("SERIF", Font.PLAIN, 84);
    ...
    private void render(Graphics g) {
        ...
        if (status == GameStatus.NOT_STARTED) {
          drawCenteredString(g2d, "SNAKE GAME IN JAVA", FONT_M, 200);
        ...
        g2d.drawString("SCORE: " + String.format ("%02d", points), 60, 30);
